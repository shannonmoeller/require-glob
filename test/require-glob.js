...
import requireGlob from '../src/index.js';
...
test('should use custom mapper', async (t) => {
	const deep = requireGlob.sync('./fixtures/deep/**/*.js', {
		mapper(options, filePath, i) {
			switch (i) {
				// The reducer expects an object path and exports properties
				case 0:
					return null;
...
test('should use custom reducer', async (t) => {
	...
	const expected = ['a1', 'a2', '_b.b1', 'b.b2', 'b1', 'b2'];
